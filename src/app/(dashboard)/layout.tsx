    ...
    <div className="flex h-full flex-col bg-gray-900 text-white">
      ...
      <div className="flex h-16 items-center px-6 border-b border-gray-800">
        <Link href="/dashboard" className="flex items-center gap-2">
          ...
          <span className="text-lg font-semibold tracking-tight">VCConnect</span>
        </Link>
      </div>
      ...
      <div className="border-t border-gray-800 p-3">
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <button className="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-sm text-gray-300 hover:bg-gray-800 hover:text-white transition-colors">
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <header className="flex h-14 items-center gap-4 border-b bg-white px-4 lg:hidden">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold">VCConnect</span>
          </div>
        </header>
